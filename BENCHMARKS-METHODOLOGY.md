...
> **TL;DR:** The "97/97 @ 100 %" number in our docs is a
...
`conformance_audit` (invoked via `/vibe-audit` or the CLI) runs 97
internal probes (at v0.26.0; count grows with each release) that check
...
Passing 97/97 means: **"the runtime has not regressed against its own
specification."**
...
|---|---|
| "97/97 probes pass" | All internal regression invariants hold |
