# Project overlay — VibecodeKit Hybrid Ultra v0.26.0

This project uses the VibecodeKit **v0.26.0** overlay (canonical version
...
- `/vibe-audit`        — 97-probe internal conformance self-test ([methodology](../BENCHMARKS-METHODOLOGY.md))
...
Before shipping:
1. `pytest tests/ -q` → 1566+/1566+ pass at v0.26.0 (full suite, run từ repo
   ...
   full suite.
2. `/vibe-audit` → 97/97 internal regression probes (self-test, not external benchmark)
