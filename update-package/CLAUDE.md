# Project overlay — VibecodeKit Hybrid Ultra v0.25.1

This project uses the VibecodeKit **v0.25.1** overlay (canonical version
...
Before shipping:
1. `pytest tests/ -q` → 1731+/1731+ pass at v0.25.1 (full suite, run từ repo
